...
Example:
    python csv_to_accdb.py data/synthetic_dataset.csv data/synthetic_dataset2.csv -o data/synthetic_data.accdb
...
Note: This script requires Windows with Microsoft Access ODBC driver.
    ...
    parser.add_argument('-o', '--output', required=True, help='Output Access database file (.accdb)')
